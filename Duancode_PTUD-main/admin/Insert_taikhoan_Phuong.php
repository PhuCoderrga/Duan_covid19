                        ...
                        <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
                            <table width="813" border="1" align="center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        $p->loadcompo_phuong("select MaPhuong, TenPhuong from phuong order by MaPhuong asc", $layid_Tang);
                                        ?>
                                        <label for="txtid"></label>
                                        <input name="txtid" type="hidden" id="txtid" value="<?php echo $layid; ?>" />
                                    </td>
                                            ...
                                            case 'Thêm sản phẩm': {
                                                    ...
                                                    if ($TaiKhoan != '') {
                                                        ...
                                                        if (mysqli_num_rows($result) > 0) {
                                                            ...
                                                            if ($p->themxoasua("INSERT INTO taikhoan (TaiKhoan ,MatKhau ,PhanQuyen, unique_id, TrangThai, MaPhuong ) VALUES ('$TaiKhoan', '$MatKhau', '$id_quyen', '$ran_id', '$trangthai', '$id_phuong');") == 1) {
                                                                if ($p->themxoasua("INSERT INTO nhanvienytephuong (`MaNV` ,`HoTen` ,`SDT` ,`DiaChi` ,`MaPhuong`)VALUES ('$TaiKhoan', '', '', '', '$id_phuong' );") == 1) {
